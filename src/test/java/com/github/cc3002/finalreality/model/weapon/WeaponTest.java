...
class WeaponTest {
  ...
  private static final int MAGICDAMAGE = 9;
  ...
  void setUp() {
    ...
    testStaff = new Staff(STAFF_NAME, DAMAGE, SPEED,MAGICDAMAGE);
  ...
  void constructorTest() {
    ...
    var expectedStaff = new Staff(STAFF_NAME, DAMAGE, SPEED,MAGICDAMAGE);
